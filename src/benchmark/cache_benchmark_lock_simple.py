		...
		for pinning in pinning_settings:
			...
			for thread_count in thread_counts:
			    ...
			    command = perfcmd + realcmd
                            ...
                            print (bin_dir_path + '/' + 'perf_magic_simple')
                            cachedata = subprocess.Popen(bin_dir_path + '/' + 'perf_magic_simple', stdin=subprocess.PIPE, stdout=subprocess.PIPE).communicate(outErr)[0]
