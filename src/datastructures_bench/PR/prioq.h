...
#define SENTINEL_KEYMIN ( INT_MIN ) /* Key value of first dummy node. */
#define SENTINEL_KEYMAX ( INT_MAX ) /* Key value of last dummy node.  */
...
extern void insertq(pq_t *pq, pkey_t k, pval_t v);
